...
export default function SlopRadar() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center relative" style={{ backgroundColor: "#FBF6EC" }}>
          ...
          >
            {deck.slice(currentIndex, currentIndex + VISIBLE_STACK).map((item, offset) => {
              ...
              return (
                ...
                >
                  <div
                    ref={isTop ? gesture.ref : undefined}
                    className="absolute inset-0 rounded-2xl p-1.5 sm:p-3 flex flex-col justify-center no-callout"
                    style={{
                    ...
                    onPointerUp={isTop ? gesture.bind.onPointerUp : undefined}
                    onPointerCancel={isTop ? gesture.bind.onPointerCancel : undefined}
                  >
                  <div
      ...
      {modalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-2 sm:px-5 fade-in" style={{ backgroundColor: "rgba(51,46,41,0.45)" }}>
          <div
            className={`w-full max-w-md sm:max-w-sm rounded-2xl p-5 sm:p-7 rise-in overflow-y-auto${gameOver ? " review-modal" : ""}`}
            style={{
              backgroundColor: "#FFFEFB",
